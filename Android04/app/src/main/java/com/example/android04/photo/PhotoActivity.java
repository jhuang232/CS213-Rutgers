...
public class PhotoActivity extends AppCompatActivity implements SwipeGestureListener.OnSwipeListener, ReturnUtilInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currPhoto == null) {
            // Handle the case when currPhoto is null
        ...
        // Set up RecyclerView with TagAdapter and LeftSwipeDelete
        ...
        // Set up for photoDisplayImageView to be swipeable for slideshow
        ...
        // Initializes all the fields in the view
        ...
        // Set up click listener for the add tag button
    ...
    public void showTagDialog(Context context) {
        ...
        // Setup Spinner and TagValue adapters and other configs
        ...
        builder.setPositiveButton("Add", (dialog, which) -> {
            ...
            if(!TextUtils.isEmpty(tagValue)
                ...
                Toast.makeText(context, "Error: Invalid tagValue or Already has tag of type \"Location\"", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onSwipeLeft() {
        if (currPhotoPosition < currAlbum.getPhotos().size() - 1) {
            ...
            Toast.makeText(this, "You've reached the last photo", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onSwipeRight() {
        if (currPhotoPosition > 0) {
            ...
            Toast.makeText(this, "You're at the first photo", Toast.LENGTH_SHORT).show();
        }
    }
