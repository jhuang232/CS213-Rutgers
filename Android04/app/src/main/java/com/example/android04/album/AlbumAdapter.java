package com.example.android04.album;
...
import com.example.android04.common.Album;
import com.example.android04.common.AppData;
import com.example.android04.common.Photo;
import com.example.android04.photo.PhotoActivity;
...
public class AlbumAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Returns the extracted photo object form currentlyClicked
     */
    ...
    private void handlePhotoViewHolder(PhotoViewHolder photoViewHolder, int position, int screenWidth) throws IOException {
        ...
        layoutParams.width = screenWidth / 3; // 3 for the 3 columns
    ...
    /**
     * Takes the result from gallery and adds it to the currAlbum
     */
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == GALLERY_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if(!(currAlbum.hasPhoto(selectedImageUri))){
                ...
                Toast.makeText(context.getApplicationContext(), "This photo already exists in this album.",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    // ViewHolder for the additional item
